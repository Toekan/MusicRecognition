    ...
    while startrecording:
        ...
        while outlier is False:
            ...
            if differencebests >= 10:
                ...
                print("Correct song:", songlibrary[bestbinlist[0][0]].split('\\')[-1], bestbinlist[0][1])
                print("2nd song:", songlibrary[bestbinlist[1][0]].split('\\')[-1], bestbinlist[1][1])
                print("3rd song:", songlibrary[bestbinlist[2][0]].split('\\')[-1], bestbinlist[2][1])
                print("4th song:", songlibrary[bestbinlist[3][0]].split('\\')[-1], bestbinlist[3][1])
                print("5th song:", songlibrary[bestbinlist[4][0]].split('\\')[-1], bestbinlist[4][1])
            ...
            if time.clock() - absolutetime > 60:
                ...
                print(songlibrary[bestbinlist[0][0]].split('\\')[-1], bestbinlist[0][1])
                print(songlibrary[bestbinlist[1][0]].split('\\')[-1], bestbinlist[1][1])
                print(songlibrary[bestbinlist[2][0]].split('\\')[-1], bestbinlist[2][1])
                print(songlibrary[bestbinlist[3][0]].split('\\')[-1], bestbinlist[3][1])
                print(songlibrary[bestbinlist[4][0]].split('\\')[-1], bestbinlist[4][1])
